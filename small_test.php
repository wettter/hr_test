 ...
 * [6]=========================================
 *
 * Пусть есть таблица tbl_phones (phone_number, daily_payment_id),
 * (каждый daily_payment_id встречается в таблице ровно один раз),
 * на каждом номере их может быть несколько.
 *
 * И пусть есть таблица tbl_payments (daily_payment_id, day_id, flag),
 * где day_id принимает значения от 1 до 30,
 * flag равен 1, если платеж прошел, иначе равен 0.
 *
 * Нужно написать SQL-запрос,
 * который выбирает номера phone_number,
 * у которых не прошел ни один платеж за все 30 дней
 */
